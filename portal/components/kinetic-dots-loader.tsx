      ...
      <div className='flex gap-5'>
        {[...Array(dots)].map((_, i) => (
          ...
          >
            ...
            >
              <div
                className='w-full h-full rounded-full bg-linear-to-b from-amber-300 to-yellow-600 shadow-[0_0_15px_rgba(212,175,55,0.6)]'
                style={{
            ...
            <div
              className='absolute bottom-0 w-10 h-3 border border-amber-400/30 rounded-[100%] opacity-0'
              style={{
            ...
            {/* 3. REFLECTIVE SHADOW */}
            <div
              className='absolute -bottom-1 w-5 h-1.5 rounded-[100%] bg-amber-500/40 blur-sm'
              style={{
