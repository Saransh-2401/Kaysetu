...
export default function BillingPage() {
  ...
  return (
    <Box data-testid="billing-page-container">
      ...
      <Stack direction={{ xs: "column", md: "row" }} spacing={2.5} sx={{ mb: 2.5 }}>
        {/* Current plan */}
        <Paper sx={{ p: 2.5, flex: 1, borderRadius: 1 }} data-testid="billing-current-plan-card">
        ...
        {/* Seats */}
        <Paper sx={{ p: 2.5, flex: 1, borderRadius: 1 }} data-testid="billing-seats-card">
      ...
      <Paper sx={{ p: 2.5, borderRadius: 1, mb: 2.5 }} data-testid="billing-subscribe-card">
      ...
      {/* Payment history */}
      <Paper sx={{ p: 2.5, borderRadius: 1 }} data-testid="billing-history-card">
